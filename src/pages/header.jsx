...
// https://drive.google.com/file/d/19dD7SGTAQm4D4LdtHphp_F0GlHcW0BvZ/view?usp=sharing
           ...
           <div className='flex flex-col lg:flex-row  items-center lg:justify-evenly p-4 lg:p-2'>
               ...
               <section className='lg:max-w-md justify-center from-right  '>
                   ...
                   <div  className='flex justify-center lg:justify-start mt-5 '>
                      <Button variant="contained" sx={{backgroundColor:  '#fbbd36', color: '#fff'}}>CV</Button>
                   </div>
               </section>
